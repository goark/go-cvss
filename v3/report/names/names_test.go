...
func TestAttackVectorTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, av: metric.AttackVectorUnknown, n: "攻撃元区分", nv: "不明"},
...
func TestAttackComplexityTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, ac: metric.AttackComplexityUnknown, n: "攻撃条件の複雑さ", nv: "不明"},
...
func TestPrivilegesRequiredTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, pr: metric.PrivilegesRequiredUnknown, n: "必要な特権レベル", nv: "不明"},
...
func TestUserInteractionTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, ui: metric.UserInteractionUnknown, n: "ユーザ関与レベル", nv: "不明"},
...
func TestScopeTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, s: metric.ScopeUnknown, n: "スコープ", nv: "不明"},
...
func TestConfidentialityImpactTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, c: metric.ConfidentialityImpactUnknown, n: "機密性への影響", nv: "不明"},
...
func TestIntegrityImpactTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, i: metric.IntegrityImpactUnknown, n: "完全性への影響", nv: "不明"},
...
func TestAvailabilityImpactTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, a: metric.AvailabilityImpactUnknown, n: "可用性への影響", nv: "不明"},
...
func TestSeverityTitle(t *testing.T) {
	testCases := []struct {
		...
		{lang: language.Japanese, sv: metric.SeverityUnknown, n: "深刻度", nv: "不明"},
